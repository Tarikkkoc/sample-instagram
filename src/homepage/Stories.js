...
import Ahmed from "./img/ahmed.svg";
import Jenny from "./img/Jenny.svg";
import Linda from "./img/Linda.svg";
    ...
    <div className="w-full h-28 overflow-scroll scrollbar-hide box-border">
      <ul className="w-full flex gap-1 items-start justify-start">
        <li className="flex flex-col items-center justify-around pt-1.5 pb-1.5 cursor-pointer">
          ...
          <span className="w-20 overflow-hidden text-ellipsis flex justify-center items-start">
            Hikayelerim
          </span>
        </li>
        <li className="flex flex-col items-center justify-around pt-1.5 pb-1.5 cursor-pointer">
          ...
          <span className="w-20 overflow-hidden text-center text-ellipsis">
            Lina
          </span>
        </li>
        <li className="flex flex-col items-center justify-around pt-1.5 pb-1.5 cursor-pointer">
